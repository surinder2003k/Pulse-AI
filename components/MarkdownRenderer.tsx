...
export default function MarkdownRenderer({ content, className }: MarkdownRendererProps) {
  const proseClasses = cn(
    ...
    "prose-h1:text-4xl md:prose-h1:text-5xl prose-h1:mb-8 text-white uppercase italic",
    "prose-h2:text-2xl md:prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:text-white prose-h2:border-l-4 prose-h2:border-primary prose-h2:pl-6 uppercase italic",
    "prose-h3:text-xl md:prose-h3:text-2xl prose-h3:mt-8 prose-h3:mb-4 prose-h3:text-white/90 uppercase italic",
    "prose-p:text-base md:text-lg prose-p:leading-[1.8] prose-p:text-white/70 prose-p:mb-6 font-medium",
