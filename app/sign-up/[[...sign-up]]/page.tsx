...
export default function SignUpPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-white">
      ...
      <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_100%_0%,rgba(229,9,20,0.02),transparent_40%)] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-primary/2 rounded-full blur-[150px] -z-10" />
      ...
      <div className="flex flex-col items-center gap-12 z-10 w-full max-w-md px-6">
        <div className="flex flex-col items-center gap-6">
           ...
           <div className="flex flex-col items-center text-center">
              <div className="flex items-center gap-3 mb-2">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-primary italic">Identity Ingress</span>
              </div>
              <h2 className="text-3xl font-black tracking-tighter uppercase italic text-gray-900">
                Node <span className="text-gray-300">Initialization.</span>
              </h2>
           </div>
        </div>
        ...
        <p className="text-[9px] font-black uppercase tracking-[0.4em] text-gray-300 mt-6">
          System: Pulse AI // Protocol: v4.0.2-Acquisition
        </p>
      </div>
    </div>
  );
